        ...
        <div class="card">
          ...
          <form class="forms-sample" action="{{route('admin.page.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="请输入发生时间">
            </div>
            <div class="form-group">
              <label>图片上传</label>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="contents" name="contents" rows="4" placeholder="请输入内容"></textarea>

...
<div class="page-header">
    <h3 class="page-title">
      <a href="{{route('admin.page.history')}}" class="btn btn-success btn-xs">添加历程</a>
    </h3>
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" style="width: 200px;">发生时间</th>
                      ...
                      <tbody>
                        @foreach ($list as $item)
                            <tr>
                                ...
                                <td class="text-center"><img src="/uploads/{{ $item->picture }}" alt=""></td>
                                <td class="text-center">{{$item->contents}}</td>
                                <td class="text-center">
                                    <a class="btn btn-success btn-xs" href="{{route('admin.page.hisedit',['page'=>$item->id])}}" role="button">编辑</a>

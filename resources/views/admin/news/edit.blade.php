    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
          ...
          <form class="forms-sample" action="{{route('admin.news.update',['news'=>$news->id])}}" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" id="newstitle" name="newstitle" value="{{$news->newstitle}}" placeholder="请输入新闻标题">
              </div>
              <div class="form-group">
                <label for="keyword">关键字</label>
                <input type="text" class="form-control" id="keyword" name="keyword" value="{{$news->keyword}}" placeholder="请输入关键字">
              </div>
              <div class="form-group">
                <label for="desc">描述</label>
                <textarea class="form-control" id="desc" name="desc" rows="4" placeholder="请输入新闻描述">{{$news->desc}}</textarea>
              </div>
              <div class="form-group">
                <label for="remark">摘要</label>
                <textarea class="form-control" id="remark" name="remark" rows="4" placeholder="请输入新闻摘要">{{$news->remark}}</textarea>
              </div>
              <div class="form-group">
                <label for="read">浏览次数</label>
                <input type="text" class="form-control" id="read" name="read" value="{{$news->read}}" placeholder="请输入浏览次数">
              </div>
              <div class="form-group">
                <label>图片上传</label>
                <input type="file" name="picture" class="file-upload-default">
                <div class="input-group col-xs-12">
                  <input type="text" value="{{$news->picture}}" class="form-control file-upload-info" disabled="" placeholder="图片上传">
              ...
              <div class="form-group">
                  ...
                  <textarea class="form-control" id="alt" name="alt" rows="4" placeholder="请输入图片关键字">{{$news->alt}}</textarea>
              </div>
              <div class="form-group">
                ...
                <script id="contents" name="contents" type="text/plain">{!!$news->contents!!}</script>
              </div>

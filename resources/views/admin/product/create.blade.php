          ...
          <form class="forms-sample" action="{{route('admin.product.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="desc" name="desc" rows="4" placeholder="请输入产品描述"></textarea>
              </div>
              <div class="form-group">
                <label for="remark">摘要</label>
                <textarea class="form-control" id="remark" name="remark" rows="4" placeholder="请输入产品摘要"></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="form-check" style="width:70px;">
                  <label class="form-check-label">
                    <input type="checkbox" class="form-check-input" name="recommend" id="recommend" value="1">
                    推荐
